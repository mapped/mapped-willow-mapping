...
def main():
    ...
    root_mappings = {
        ...
        "dtmi:org:brickschema:schema:Brick:Outside_Air_Temperature_Low_Reset_Setpoint;1": ["dtmi:com:willowinc:OutsideAirTemperatureResetLowLimit;1"],
        "dtmi:org:brickschema:schema:Brick:Reset_Setpoint;1": [ "dtmi:com:willowinc:Limit;1"],
